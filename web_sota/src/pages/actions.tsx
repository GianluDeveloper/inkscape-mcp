    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <ActionCard
          ...
          onRun={() =>
            runAction("preview", "render_preview", {
        ...
        <ActionCard
          ...
          status={status.qr}
          onRun={() =>
            runAction("qr", "generate_barcode_qr", {
              barcode_data: "https://mcp-central.ai",
              output_path: "qr.svg",
            })
          }
        />

...
const STYLE_PRESETS = [
  {
    ...
    label: "Heraldic",
    icon: "⚜️",
    desc: "Crests, shields, coats of arms",
  },
  {
    id: "geometric",
    label: "Geometric",
    icon: "🔷",
    desc: "Clean shapes, patterns",
  },
  {
    id: "organic",
    label: "Organic",
    icon: "🌿",
    desc: "Natural, flowing forms",
  },
  {
    id: "abstract",
    label: "Abstract",
    icon: "🎨",
    desc: "Artistic, conceptual",
  },
  {
    id: "technical",
    label: "Technical",
    icon: "⚙️",
    desc: "Diagrams, schematics",
  },
];
...
const API_BASE = import.meta.env.VITE_API_URL || "http://127.0.0.1:11028";
...
export function SvgStudio() {
  ...
  const [activeHistoryItem, setActiveHistoryItem] =
    useState<GeneratedSvg | null>(null);
            ...
            <div className="mb-3 flex items-center justify-between">
              ...
              {displayedSvg && (
                <div className="flex items-center gap-3 text-sm text-slate-400">
                  ...
                  {displayedSvg.steps && (
                    <span>{displayedSvg.steps} SEP-1577 steps</span>
                  )}
                  {activeHistoryItem && (
                    <button
